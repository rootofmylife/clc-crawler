...
class DautuVneconomySpider(scrapy.Spider):
    name = 'dautu_vneconomy'
    start_urls = ['https://vneconomy.vn/dau-tu.htm']
    custom_settings = { 'FEED_URI': "dautu_vneconomy_%(time)s.json",
                       'FEED_FORMAT': 'json',
    ...
    def parse(self, response):
        ...
        while count < 18:
            ...
            main_url = 'https://vneconomy.vn/dau-tu.htm' + extent_url
