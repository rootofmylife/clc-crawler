...
class BaohiemVneconomySpider(scrapy.Spider):
    name = 'baohiem_vneconomy'
    start_urls = ['http://vneconomy.vn/bao-hiem-tai-chinh.htm']
    custom_settings = { 'FEED_URI': "baohiem_vneconomy_%(time)s.json",
                       'FEED_FORMAT': 'json',
    ...
    def parse(self, response):
        ...
        while count < 2:
            ...
            main_url = 'https://vneconomy.vn/bao-hiem-tai-chinh.htm' + extent_url
